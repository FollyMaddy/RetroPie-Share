...
function configure_supermodel-mechafatnick() {
    ...
    #addEmulator 0 "Supermodel-mechafatnick-normal" "supermodel" "XINIT:pushd /opt/retropie/emulators/supermodel;/opt/retropie/emulators/supermodel-mechafatnick/bin/supermodel -fullscreen -res=800,600 -wide-screen -stretch -legacy3d -sound-volume=50 -music-volume=60 -no-vsync -no-throttle -no-dsb -res=800,600 %ROM%"
    ...
    #addEmulator 0 "Supermodel-mechafatnick-normal" "supermodel" "XINIT:/opt/retropie/emulators/supermodel-mechafatnick/bin/supermodel -fullscreen -res=800,600 -wide-screen -stretch -legacy3d -sound-volume=50 -music-volume=60 -no-vsync -no-throttle -no-dsb -res=800,600 %ROM%"
