...
",(Mirror)Download/update mame artwork (+/-30 min.),,download_from_google_drive 1L-6Q9K5jJANEXgfhbPAS-37iCa96_lka /home/$user/RetroPie/roms/mame/artwork,,,,,dialog_message \"Here you will find the artwork files needed for a lot of handheld games and it's basically only working on MAME standalone. Some artwork files are custom made others are from other sources. Though we changed the background and bezel filenames in the archives so the options 'Create RetroArch xxxxxxxxxxx-overlays' can make use of these artwork files by extracting the overlay pictures and use them for lr-mess and lr-mame in retroarch.\","
...
",RetroPie/roms/deco_cassette90º < (  60+ ) ${rompack_link_info[0]},,subform_restricted_multi_download_wget_A '/DECO/' ${rompack_link_info[1]} /home/$user/RetroPie/roms/deco_cassette90º ${rompack_link_info[2]} download,,,,,dialog_message \"NO HELP\","
",,,,"
",v HELP > Get all 90º orientated files from a specific category,,,"
