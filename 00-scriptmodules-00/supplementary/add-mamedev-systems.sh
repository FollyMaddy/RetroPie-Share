...
",All in One Handheld and Plug and Play,@non-arcade,create_rom_index_file '/@all_in1/' /home/$user/RetroPie/roms/all_in1;run_generator_script ablmini,,,,,dialog_message \"The name All In One Handheld and Plug & Play was chosen for systems with multiple games like the concept 100 in 1. The ROMs are from the MAME romset collection and you can find the list on (Tutorial: Handheld and Plug & Play systems with MAME) thread on the RetroPie Forum. Most of those games are bootlegs_ mini-games or sport games. The original systems are Handhelds or Plug & Play.\","
",Classic Handheld Systems,@non-arcade,create_rom_index_file '/@classich/' /home/$user/RetroPie/roms/classich;run_generator_script alnattck,,,,,dialog_message \"Non_game & watch from MADrigal Romset and all other manufacturers in the MAME romset such as Coleco_ Entex_ etc. You can get the ROM list on (Tutorial: Handheld and Plug & Play systems with MAME) on RetroPie Forum.\n\nYou can get artworks and backgrounds for those games with the (Select downloads) menu below\","
",Classic Handheld Systems (+ lr-gw from source),@non-arcade,run_generator_script alnattck;echo -e 'install regular lr-gw from source\ndelete possible old lr-gw line and empty line(s) in /opt/retropie/configs/classich/emulators.cfg\npaste new lr-gw line in /opt/retropie/configs/classich/emulators.cfg';$scriptdir/retropie_packages.sh lr-gw;sed -i -e 's/lr-gw.*//g;/^$/d' /opt/retropie/configs/classich/emulators.cfg;cat /opt/retropie/configs/gameandwatch/emulators.cfg|grep lr-gw >> /opt/retropie/configs/classich/emulators.cfg,,,,,dialog_message \"Non_game & watch from MADrigal Romset and all other manufacturers in the MAME romset such as Coleco_ Entex_ etc. You can get the ROM list on (Tutorial: Handheld and Plug & Play systems with MAME) on RetroPie Forum.\n\nYou can get artworks and backgrounds for those games with the (Select downloads) menu below\"," 
",Game and Watch,@non-arcade,create_rom_index_file '/@gameandwatch/' /home/$user/RetroPie/roms/gameandwatch;run_generator_script gnw_ball,,,,,dialog_message \"Set to run all  MADrigal and MAME romset. With those 2 (MADrigal and MAME)_  you can play the entire Game & Watch collection. You can get the ROM list on (Tutorial: Handheld and Plug & Play systems with MAME) on RetroPie Forum\n\nYou can get artworks and backgrounds for those games with the (Select downloads) menu below\","
",JAKKS Pacific TV Games,@jakks,create_rom_index_file '/@classich/' /home/$user/RetroPie/roms/jakks;run_generator_script jak_batm,,,,,dialog_message \"JAKKS Pacific TV Games - You can get the ROM list on (Tutorial: Handheld and Plug & Play systems with MAME) on RetroPie Forum\","
",Konami Handheld,@non-arcade,create_rom_index_file '/@konamih/' /home/$user/RetroPie/roms/konamih;run_generator_script kbilly,,,,,dialog_message \"Konami Handheld - You can get the ROM list on (Tutorial: Handheld and Plug & Play systems with MAME) on RetroPie Forum\n\nYou can get artworks and backgrounds for those games with the (Select downloads) menu below\","
...
",Arcade Category => Puzzle,@arcade,create_rom_index_file '/@puzzle/&&/@working_arcade/' /home/$user/RetroPie/roms/puzzle;run_generator_script 3kokushi,,,,,dialog_message \"NO HELP\","
...
",,,,"
",Setup Orionsangels Realistic Arcade Overlays > roms/realistic,@arcade,create_rom_index_file '/@working_arcade/' /home/$user/RetroPie/roms/realistic;run_generator_script realistic realistic '' '' 'none' '';download_from_google_drive 1m_8-LJpaUFxUtwHCyK4BLo6kiFsvMJmM /home/pi/RetroPie/downloads;organise_realistic_overlays,"
    )
    build_menu_add-mamedev-systems
}
