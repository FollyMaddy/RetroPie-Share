...
function build_mame() {
    ...
    # Compile MAME
    local params=("CFLAGS=-m32 -march=prescott -mtune=i686 -O2" "CXXFLAGS=-m32 -march=prescott -mtune=i686 -O2" NOWERROR=1 ARCHOPTS=-U_FORTIFY_SOURCE PYTHON_EXECUTABLE=python3)
