...
function build_mame() {
    ...
    local params=("CFLAGS=-m64 -march=x86-64 -mtune=generic -O2" "CXXFLAGS=-m64 -march=x86-64 -mtune=generic -O2" NOWERROR=1 ARCHOPTS=-U_FORTIFY_SOURCE PYTHON_EXECUTABLE=python3 OPTIMIZE=2 USE_SYSTEM_LIB_FLAC=1)
